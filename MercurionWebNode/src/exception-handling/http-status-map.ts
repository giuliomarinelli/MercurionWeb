export const HTTPStatuses: { [key: number]: string } = {
    /**
...
export class HttpStatusMap {
    public static getDescriptionFromHttpStatusCode(statusCode: number): string {
        return HTTPStatuses[statusCode] || "Internal Server Error"
    }
}