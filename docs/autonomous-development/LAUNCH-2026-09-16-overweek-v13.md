# Mercurion Code Red — overweek autonomous full-Series launch v13
...
`2026-09-23T10:00:00+02:00` (Europe/Rome, CEST), sette giorni dopo la
preparazione del launch.

The current active snapshot contains 173 `DONE`, 13 `PENDING`, 7 `BLOCKED`,
22 `SKIPPED_DEPENDENCY` and no `REVERTED` recipes. Five reserved
...
after 2026-09-23T10:00:00+02:00. Require a clean, synchronized develop and a
...
13 PENDING recipes; terminal recipes remain in scope only for state validation
...
the authoritative planner output; the expected first READY task is 0171.
...
All 173 recipes currently marked `DONE` are terminal; never select them again.
...
Tasks `0072/UI-014`, `0081/UI-023`, `0102/NG-016`, `0126/BE-012`,
`0147/BE-033`, `0179/DATA-030` and `0209/QA-023` are `BLOCKED`; their feature
branches remain frozen. The 22 recipes currently marked `SKIPPED_DEPENDENCY`
...
branches `feature/UI-014`, `feature/UI-023`, `feature/NG-016`,
`feature/BE-012`, `feature/BE-033`, `feature/DATA-030` and `feature/QA-023`,
...
`npm run autonomous:assert-finalizable -- docs/autonomous-development/session.overweek-2026-09-23-v13.yaml`
