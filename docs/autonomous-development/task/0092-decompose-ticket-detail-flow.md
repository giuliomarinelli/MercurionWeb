...
### Summary
Not attempted because the required canonical action/dialog/form/page-state
primitives from earlier UI tasks are terminally unavailable.
...
The prerequisite UI tasks include terminal skipped dependencies originating at
FE-030 (BLOCKED). FE-030 requires filesystem-write capability for a fresh,
