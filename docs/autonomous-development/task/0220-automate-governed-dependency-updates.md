...
Direct terminal prerequisites include `0210` (`QA-024`) and `0211` (`QA-025`),
both newly `SKIPPED_DEPENDENCY` through root `0071` (`UI-013`), `BLOCKED`.
Materialized on 2026-09-13.
