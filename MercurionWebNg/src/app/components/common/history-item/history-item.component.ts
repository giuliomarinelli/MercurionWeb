      ...
      >
        ...
        <div class="flex flex-col justify-center min-w-0 transition-colors duration-300">
          ...
          <div class="flex items-center gap-1">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" class="size-3 fill-current relative top-px text-light-accent-primary dark:text-dark-accent-primary">
