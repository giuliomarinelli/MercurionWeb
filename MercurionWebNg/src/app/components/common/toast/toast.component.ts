...
@Component({
  ...
  template: `
    @if (toast.show()) {
      <div
        class="fixed top-8 right-4 z-50 sm:max-w-sm w-[250px] 2xs:w-[320px] xs:w-full mx-4 px-4 py-6 text-lg rounded-md text-white shadow-lg transition-all duration-700 transform"
        [ngClass]="className"
