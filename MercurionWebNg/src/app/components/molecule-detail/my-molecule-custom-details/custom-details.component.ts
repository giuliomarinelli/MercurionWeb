      ...
      <div class="flex items-center gap-4 min-w-0">
        ...
        @if (!_isReadonly()) {
          @if (mode() === 'view') {
            ...
            <button type="button"
                    class="ml-3 relative z-30 cursor-pointer transition-colors duration-300 hover:transform hover:scale-[1.05]"
                    title="Modifica"
                    (click)="doEdit()">
      ...
      @case ('name') {
        <div class="flex items-center gap-6">
          <h2 id="molecule-name"
            ...
            @if (mode() === 'view') {
              <button class="cursor-pointer transition-colors duration-300 hover:transform hover:scale-[1.075]" title="Modifica" (click)="doEdit()">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
              ...
              <div class="flex justify-center gap-2">
                <button class="cursor-pointer transition-colors duration-300 hover:transform hover:scale-[1.075]" title="Annulla" (click)="doCancel()">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
                ...
                <button class="cursor-pointer transition-colors duration-300 hover:transform hover:scale-[1.075]" title="Salva" (click)="doSave()">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
      ...
      @default {
        ...
        <div class="flex text-center sm:text-left gap-3 items-center"
          ...
          @if (_type() !== 'name') {
            ...
            @if (mode() === 'view') {
              <button type="button"
                  class="ml-5 cursor-pointer transition-colors duration-300 hover:transform hover:scale-[1.075]"
                  title="Modifica"
                  (click)="onEdit($event)">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"
                     class="h-6 w-auto fill-current text-slate-800 hover:text-slate-800/75 dark:text-slate-200 dark:hover:text-slate-200/75">
