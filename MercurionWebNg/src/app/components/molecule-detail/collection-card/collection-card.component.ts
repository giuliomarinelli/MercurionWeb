        ...
        <div class="clip-wrapper">
          ...
          <div class="clip-viewport">
            ...
            >
              ...
              <!-- Footer -->
              <div class="md:col-span-12 mt-1 md:mt-0 flex flex-col sm:flex-row gap-3 sm:gap-3 items-start sm:items-center text-xs text-slate-700 dark:text-slate-200 justify-between w-full">
