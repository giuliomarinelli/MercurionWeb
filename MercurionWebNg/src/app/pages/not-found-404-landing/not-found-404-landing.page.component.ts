  ...
  template: `
    ...
    <main class="absolute inset-0 z-[50] grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8 dark:bg-gray-950">
      <div class="text-center">
        <p class="text-5xl font-semibold text-light-accent-primary dark:text-dark-accent-primary-btn">404</p>
        <h1 class="mt-4 text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl dark:text-white">Pagina non trovata.</h1>
        <p class="mt-6 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8 dark:text-gray-400">Siamo spiacenti, ma non siamo riusciti a trovare la pagina o il contenuto che cercavi.</p>
