    ...
    @if (canView()) {
      <div class="min-h-screen flex flex-col items-center px-4 py-12 relative top-6">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="w-16 h-auto mb-6"
          viewBox="0 0 512 512">
          <path class="fill-current text-light-accent-primary-hc dark:text-slate-400"
              ...
              <p class="text-sm text-center relative bottom-2">
                ...
                @switch (view()) {
                  @case ('EMAIL_OTP') {
                    ...
                    <span class="text-light-accent-primary-hc dark:text-dark-accent-primary font-semibold">
