...
@if (templateIsMounted()) {
  <div class="min-h-screen flex flex-col items-center px-4 pt-9">
    ...
    <h1 class="text-2xl font-semibold text-gray-900 mb-8 tracking-wider dark:text-slate-100 text-center">
      Piacere di averti qui.
    </h1>

    <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" class="w-full max-w-sm space-y-6">
      @if (step() === 1) {
        <div class="mt-2">
          <m-floating-input
        ...
        <div class="flex justify-center">
          @if (loadingTurnstile()) {
            <div class="w-[300px] h-[71px] overflow-hidden transition-all bg-neutral-200 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 animate-pulse skeleton-pulse">
      ...
      <div class="space-y-3 dark:text-slate-100">
        <a href="/api/oauth2/sso/Google/login" class="w-full flex items-center justify-center border rounded-md py-2.5 text-sm dark:hover:bg-slate-100 gap-3 dark:hover:text-neutral-900 hover:bg-slate-200/80 bg-slate-200 dark:bg-transparent transition-colors duration-150">
        ...
        <a href="/api/oauth2/sso/LinkedIn/login" class="w-full flex items-center justify-center border rounded-md py-2.5 text-sm dark:hover:bg-slate-100 gap-3 dark:hover:text-neutral-900 hover:bg-slate-200/80 bg-slate-200 dark:bg-transparent transition-colors duration-150">
          <div class="relative">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-auto fill-current absolute -top-[4px] -left-[34px]" viewBox="0 0 640 640">
        ...
        <a href="/api/oauth2/sso/GitHub/login" class="w-full flex items-center justify-center border rounded-md py-2.5 text-sm dark:hover:bg-slate-100 gap-3 dark:hover:text-neutral-900 hover:bg-slate-200/80 bg-slate-200 dark:bg-transparent transition-colors duration-150">
          <div class="relative">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-[26px] w-auto fill-current absolute -top-3 -left-[22px]" viewBox="0 0 640 640">
        ...
        <a href="/api/oauth2/sso/Discord/login" class="w-full flex items-center justify-center border rounded-md py-2.5 text-sm dark:hover:bg-slate-100 gap-3 dark:hover:text-neutral-900 hover:bg-slate-200/80 bg-slate-200 dark:bg-transparent transition-colors duration-150">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-auto fill-current" viewBox="0 0 640 640">
            <path d="M524.2 133.7z"/>
          </svg>
