...
@Component({
  ...
  template: `
    <section class="main-container" role="main" aria-labelledby="feedback-heading">
      ...
      <div class="flex gap-6 items-center px-6 py-4 bg-slate-100 dark:bg-slate-900 rounded-lg border border-slate-300 dark:border-slate-700">
      ...
      <div class="mt-5 w-full rounded-2xl bg-slate-100 dark:bg-slate-900/80 backdrop-blur-md p-5 border border-slate-300 dark:border-slate-700">
